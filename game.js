...
function render(){$("cash").textContent=s.cash.toLocaleString("ar-EG");$("respect").textContent=s.respect;$("power").textContent=s.power;$("energy").textContent=s.energy+"/100";$("hq").textContent=s.hq;$("hq2").textContent=s.hq;$("members").textContent=s.members;$("power").textContent=s.power+"/100";$("respectBar").textContent=s.respect+"/100";$("energyFill").style.width=Math.min(100,s.energy)+"%";$("powerFill").style.width=Math.min(100,s.power)+"%";$("respectFill").style.width=Math.min(100,s.respect)+"%";$("level").textContent=s.hq;$("xpText").textContent=Math.min(100,s.respect)+" / 100";$("xpFill").style.width=Math.min(100,s.respect)+"%";const c=Math.floor(500*Math.pow(1.65,s.hq-1));$("upgradeCost").textContent=c.toLocaleString("ar-EG");$("upgrade").disabled=s.cash<c||s.energy<10}
